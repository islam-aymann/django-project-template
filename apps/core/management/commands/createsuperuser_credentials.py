...
class Command(BaseCommand):
    """Create a superuser with the given username, password and email from commandline or using the default values
    Example:
        manage.py createsuperuser_credentials --username=admin --password=admin --email=admin@admin.com
        or
        manage.py createsuperuser_credentials
    """
